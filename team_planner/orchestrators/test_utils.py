...
class TestDataFactory:
    ...
    def create_department(name="Test Department", manager=None):
        ...
        return Department.objects.create(
            name=name, description=f"Description for {name}", manager=manager,
        )
    ...
    def create_employee_profile(user, **defaults):
        ...
        return EmployeeProfile.objects.create(user=user, **profile_defaults)
    ...
    def create_team_membership(user, team, role="member"):
        ...
        return TeamMembership.objects.create(
            user=user, team=team, role=role, is_active=True,
        )
    ...
    def create_test_scenario(
        ...
        for i in range(num_employees):
            ...
            TestDataFactory.create_employee_profile(
                user=user,
...
class BaseTestCase:
    ...
    def create_additional_employee(self, username=None, **kwargs):
        ...
        TestDataFactory.create_employee_profile(
            user=user, team=self.team, **kwargs,
        )
        return user
