...
class OrchestrationRun(TimeStampedModel):
    ...
    schedule_incidents_standby = models.BooleanField(
        _("Schedule Incidents-Standby"), default=False,
    )
    ...
    # Results and metrics
    total_shifts_created = models.PositiveIntegerField(
        _("Total Shifts Created"), default=0,
    )
    incidents_shifts_created = models.PositiveIntegerField(
        _("Incidents Shifts Created"), default=0,
    )
    incidents_standby_shifts_created = models.PositiveIntegerField(
        _("Incidents-Standby Shifts Created"), default=0,
    )
    waakdienst_shifts_created = models.PositiveIntegerField(
        _("Waakdienst Shifts Created"), default=0,
    )
...
class OrchestrationResult(TimeStampedModel):
    ...
    assignment_reason = models.TextField(
        _("Assignment Reason"), help_text=_("Algorithm's reason for this assignment"),
    )
...
class OrchestrationConstraint(TimeStampedModel):
    ...
    constraint_type = models.CharField(
        _("Constraint Type"), max_length=30, choices=ConstraintType.choices,
    )
    severity = models.CharField(
        _("Severity"), max_length=20, choices=Severity.choices, default=Severity.HARD,
    )
