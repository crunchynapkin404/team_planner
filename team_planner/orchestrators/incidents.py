...
class IncidentsOrchestrator(BaseOrchestrator):
    ...
    def _create_fairness_calculator(self) -> BaseFairnessCalculator:
        ...
        return FairnessCalculatorFactory.create_incidents_calculator(self.start_date, self.end_date)
    ...
    def _generate_period_assignments(self, period_start: datetime, period_end: datetime, 
        ...
        for assignment in self.current_assignments:
            ...
            if emp_id and emp_id in [emp.pk for emp in available_employees] and shift_type == 'incidents':
                if emp_id not in current_assignments:
                    current_assignments[emp_id] = {'incidents': 0.0}
