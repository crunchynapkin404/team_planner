...
class Team(TimeStampedModel):
    ...
    timezone = models.CharField(
        ...
        help_text=_("IANA timezone name for this team's scheduling (e.g., Europe/Amsterdam)")
    )
    ...
    incidents_skip_holidays = models.BooleanField(
        ...
        default=True,
        help_text=_("If true, do not generate incidents/standby on holidays; waakdienst continues")
    )
    ...
    joiner_grace_weeks = models.PositiveSmallIntegerField(
        ...
        help_text=_("Weeks after joining before heavy shifts (e.g., waakdienst) are assigned")
    )
    joiner_bootstrap_credit_hours = models.DecimalField(
        ...
        blank=True,
        default=None,
        help_text=_("Optional initial credit hours for fairness; leave blank to disable")
    )
