...
def respond_to_swap_request_api(request, pk):
    ...
    try:
        ...
        if action == 'approve':
            ...
            # TODO: Implement the actual shift swapping logic
            # This would involve updating the assigned_employee for both shifts
...
def user_incoming_swap_requests_api(request):
    ...
    requests_data = [{
        ...
        'requester': {
            ...
            'first_name': swap.requesting_employee.first_name_display,
            'last_name': swap.requesting_employee.last_name_display,
        },
        'target_employee': {
            'id': swap.target_employee.pk,
            'username': swap.target_employee.username,
            'first_name': swap.target_employee.first_name_display,
            'last_name': swap.target_employee.last_name_display,
        },
        'requesting_shift': {
        ...
        'reason': swap.reason,
        'status': swap.status,
        'response_notes': swap.response_notes,
        'created_at': swap.created.isoformat(),
        'approved_by': {
            'username': swap.approved_by.username,
            'first_name': swap.approved_by.first_name_display,
            'last_name': swap.approved_by.last_name_display,
...
def get_team_members_api(request):
    ...
    try:
        ...
        members_data = [{
            ...
            'first_name': user.first_name_display,
            'last_name': user.last_name_display,
