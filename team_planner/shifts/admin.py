...
from .models import (
    ShiftTemplate, Shift, SwapRequest, FairnessScore, 
    TimeEntry, OvertimeEntry, SchedulingRule
)
...
class ShiftTemplateAdmin(admin.ModelAdmin):
    list_display = [
        "name", "shift_type", "duration_hours", "is_active", "created"
    ]
    ...
    fieldsets = (
        (_("Basic Information"), {
            "fields": ("name", "shift_type", "description")
        }),
        (_("Configuration"), {
...
class ShiftAdmin(admin.ModelAdmin):
    list_display = [
        "shift_summary", "assigned_employee", "status", 
        "start_datetime", "end_datetime", "auto_assigned"
    ]
    list_filter = [
        "template__shift_type", "status", "auto_assigned", 
        "start_datetime", "created"
    ]
    search_fields = [
        "assigned_employee__username", "assigned_employee__first_name", 
        "assigned_employee__last_name", "template__name", "notes"
    ]
    ...
    fieldsets = (
        (_("Shift Details"), {
            "fields": ("template", "assigned_employee", "start_datetime", "end_datetime")
        }),
        (_("Status & Notes"), {
            "fields": ("status", "notes")
        }),
...
class SwapRequestAdmin(admin.ModelAdmin):
    list_display = [
        "swap_summary", "status", "created", "approved_by", "approved_datetime"
    ]
    list_filter = ["status", "created", "approved_datetime"]
    search_fields = [
        "requesting_employee__username", "requesting_employee__first_name",
        "requesting_employee__last_name", "target_employee__username",
        "target_employee__first_name", "target_employee__last_name",
    ...
    fieldsets = (
        (_("Swap Details"), {
            "fields": (
                ...
                "requesting_shift", "target_shift"
            )
        }),
        (_("Request Information"), {
            "fields": ("reason", "status", "response_notes")
        }),
        (_("Approval"), {
            "fields": ("approved_by", "approved_datetime"),
            "classes": ("collapse",)
        }),
    )
...
class FairnessScoreAdmin(admin.ModelAdmin):
    list_display = [
        "employee", "period_summary", "incidents_days", "waakdienst_days",
    ...
    readonly_fields = [
        "incidents_fairness_score", "waakdienst_fairness_score", 
        "overall_fairness_score"
    ]
    ...
    fieldsets = (
        ...
        (_("Shift Days"), {
            "fields": (
                "incidents_days", "waakdienst_days", 
                "changes_days", "projects_days"
            )
        }),
        (_("Fairness Scores"), {
            "fields": (
...
class TimeEntryAdmin(admin.ModelAdmin):
    list_display = [
        "employee", "shift", "clock_in", "clock_out", 
        "total_hours", "created"
    ]
    ...
    fieldsets = (
        (_("Time Entry"), {
            "fields": ("shift", "employee", "clock_in", "clock_out")
        }),
        (_("Breaks & Notes"), {
            "fields": ("break_duration_minutes", "notes")
        }),
    )
...
class OvertimeEntryAdmin(admin.ModelAdmin):
    list_display = [
        "employee", "date", "hours", "reason_summary", 
        "approved_by", "created"
    ]
    ...
    fieldsets = (
        (_("Overtime Details"), {
            "fields": ("employee", "shift", "date", "hours")
        }),
        (_("Approval"), {
...
class SchedulingRuleAdmin(admin.ModelAdmin):
    list_display = [
        "name", "shift_type", "priority", "is_active", "created"
    ]
    ...
    fieldsets = (
        ...
        (_("Configuration"), {
            "fields": ("priority", "is_active", "configuration")
        }),
    )
