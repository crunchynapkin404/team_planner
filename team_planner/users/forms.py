...
class RecurringLeavePatternForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "pattern_start_date": forms.DateInput(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["name"].help_text = _(
            "Give this pattern a descriptive name (e.g., 'Monday Mornings Off', 'Bi-weekly Tuesday Afternoons')",
        )
        self.fields["pattern_start_date"].help_text = _(
            "For biweekly patterns, this determines which weeks the pattern applies",
        )
        self.fields["effective_from"].help_text = _(
            "When should this pattern start being applied?",
        )
        self.fields["effective_until"].help_text = _(
            "Leave blank for permanent pattern",
        )
...
class UserProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["name"].help_text = _(
            "Your full name as it should appear in schedules",
        )
