...
from domain.value_objects import (
    ...
    TimeRange, DateRange, ShiftType, BusinessHoursConfiguration,
    TeamConfiguration, AssignmentStatus, ConflictSeverity,
    ConstraintViolation, FairnessScore, AssignmentLoad
)
...
class TestTeamConfiguration:
    ...
    def test_get_waakdienst_week_range(self):
        ...
        assert abs(week_range.duration_hours() - expected_hours) < 1  # Allow for some calculation variance
    ...
    def test_invalid_waakdienst_day(self):
        ...
        with pytest.raises(ValueError, match="waakdienst_start_day must be between 0 and 6"):
            TeamConfiguration(
                timezone='Europe/Amsterdam',
                business_hours=business_hours,
