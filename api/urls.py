...
from .orchestrator_views_v2 import OrchestratorAPIViewSet, OrchestratorStatusView

# Create router for ViewSets
router = DefaultRouter()
router.register(r'orchestrator', OrchestratorAPIViewSet, basename='orchestrator')
router.register(r'orchestrator-status', OrchestratorStatusView, basename='orchestrator-status')
...
urlpatterns = [
    ...
    path('orchestrator/availability/', 
